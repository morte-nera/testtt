#!/bin/sh
#Soluzione della Prova del 17 Febbraio 2021
...
do
        echo fase per $G
	FCR.sh $G $H $K		#invochiamo il file comandi ricorsivo con la gerarchia e i due numeri passati come primi due parametri
done
